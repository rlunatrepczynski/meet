...
defineFeature(feature, test => {
    ...
    test('Select a City from Suggestions', ({ given, and, when, then }) => {
        let AppComponent;
        let AppDOM;
        let CitySearchDOM;
        let citySearchInput;
        given('user was typing “Berlin” in the city textbox, and the list of suggested cities is showing.', async () => {
            AppComponent = render(<App />);
            const user = userEvent.setup();
